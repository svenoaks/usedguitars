...
<?php if( is_writable( osc_uploads_path()) ) { ?>
    <?php if($logo_prefence) { ?>
        ...
        <img border="0" alt="<?php echo osc_esc_html( osc_page_title() ); ?>" src="<?php echo bender_black_logo_url().'?'.filemtime(osc_uploads_path() . osc_get_preference('logo','bender_black_theme'));?>" />
